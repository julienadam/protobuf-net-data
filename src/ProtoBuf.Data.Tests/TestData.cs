...
namespace ProtoBuf.Data.Tests
{
    public static class TestData
    {
        ...
        public static DataTable SmallDataTable()
        {
            ...
            table.Columns.Add("SomeDateTimeOffset", typeof (TimeSpan));
            table.Rows.Add(new DateTime(2011, 04, 05, 12, 16, 41, 300), 42, "Foo", Guid.Parse("6891816b-a4b9-4749-a9f5-9f6deb377a65"), "sdfsdf", new byte[] { 1, 2, 3, 4 }, new[] { 'a' }, 0.1, 0.2, null, TimeSpan.Zero, DateTimeOffset.MinValue);
            table.Rows.Add(new DateTime(1920, 04, 03, 12, 48, 31, 210), null, "Bar", Guid.Parse("28545f31-ca0c-40c1-bae0-9b79ca84091b"), "o2389uf", new byte[0], new[] { 'a', 'b', 'c' }, 0.3, 0.4, 'c', TimeSpan.Zero, DateTimeOffset.MaxValue);
            table.Rows.Add(null, null, null, null, null, null, null, null, null, 'h', TimeSpan.FromMinutes(2), new DateTimeOffset(2005, 03, 18, 23, 45, 12, TimeSpan.FromHours(2)));
            table.Rows.Add(new DateTime(2008, 01, 11, 11, 4, 1, 491), null, "Foo", Guid.Empty, "", null, new char[0], -0.3, -0.4, 'a', TimeSpan.FromDays(1), new DateTimeOffset(2005, 03, 18, 23, 45, 12, TimeSpan.FromHours(-2)));
